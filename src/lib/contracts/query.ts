import { type EventId, type SuiObjectData, type SuiObjectResponse } from "@mysten/sui/client";
import { type UserProfile } from "~/types/userProfile";
import { type StampItem } from "~/types/stamp";
import { type PassportItem } from "~/types/passport";
import { graphqlClient, type NetworkVariables, suiClient } from "~/lib/contracts";
